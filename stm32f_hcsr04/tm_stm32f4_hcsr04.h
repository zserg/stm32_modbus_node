 ...
 * @}
 */
void TM_GPIO_SetPinLow(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin);

void TM_GPIO_SetPinHigh(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin);

GPIO_PinState TM_GPIO_GetInputPinValue(GPIO_TypeDef* GPIOx, uint16_t GPIO_Pin);
